...
PRIORITY_MATRIX = {
    "FAST_TRACK":  {"emoji":"🚀","label":"FAST TRACK",  "hex_color":"#059669","bg_hex":"#064E3B","action":"Reply within the hour.","sla":"< 1 hour",   "description":"Decision maker at a perfect-fit company. Move now."},
    "PURSUE":      {"emoji":"🎯","label":"PURSUE",      "hex_color":"#3B82F6","bg_hex":"#1E3A5F","action":"Prioritise today.",     "sla":"< 24 hours","description":"Strong fit. Engage before a competitor does."},
    "QUALIFY":     {"emoji":"🔍","label":"QUALIFY",     "hex_color":"#D97706","bg_hex":"#451A03","action":"Gather more info.",     "sla":"< 48 hours","description":"Company looks right. Find the decision maker."},
    "NURTURE":     {"emoji":"🌱","label":"NURTURE",     "hex_color":"#F97316","bg_hex":"#431407","action":"Keep the relationship warm.","sla":"< 1 week","description":"Good contact, weak company fit."},
